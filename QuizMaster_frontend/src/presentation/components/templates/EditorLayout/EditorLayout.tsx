...
export const EditorLayout = () => {
  ...
  return (
    <div className="w-dvw h-dvh flex flex-col">
      ...
      {vm.questionsList && (
        <main className="w-full h-full min-h-0 p-4 flex justify-center items-center gap-4">
          <EditorSideBar questionsList={vm.questionsList} onSelect={vm.onSelectQuestionId} selectedQuestionId={vm.selectedQuestionId} />
